...
- The Python script used to parse the VFR data and display the data
  - There are many already made code repo's for VFR data, but I wanted more flexibility since custom VFR maps for _Canada_ in particular aren't that common compare to USA. So I wrote a lot of my own functions for this.
